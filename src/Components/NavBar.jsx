...
const NavBar = () => {
    ...
    return (
        <header className="relative w-full py-5 px-5 flex items-center justify-between bg-white shadow-md top-0 z-50">
            <nav className="flex w-full screen-max-width items-center justify-between">

                <div className="flex items-center">
                    <a className="cursor-pointer" href="">
                        <h1 className="text-custom-blue text-3xl font-preuksa_semibold ml-5 max-md:text-lg hover:text-gray-600 transition-all">CARESHARING</h1>
                    </a>
                </div>
